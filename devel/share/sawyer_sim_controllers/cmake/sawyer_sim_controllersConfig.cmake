...
if("TRUE" STREQUAL "TRUE")
  set(sawyer_sim_controllers_SOURCE_PREFIX /home/sridevi/sawyer_ws/src/sawyer_simulator/sawyer_sim_controllers)
  set(sawyer_sim_controllers_DEVEL_PREFIX /home/sridevi/sawyer_ws/devel)
  ...
  set(sawyer_sim_controllers_INSTALL_PREFIX /home/sridevi/sawyer_ws/install)
...
if(NOT "/home/sridevi/sawyer_ws/src/sawyer_simulator/sawyer_sim_controllers/include " STREQUAL " ")
  set(sawyer_sim_controllers_INCLUDE_DIRS "")
  set(_include_dirs "/home/sridevi/sawyer_ws/src/sawyer_simulator/sawyer_sim_controllers/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sawyer_sim_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sridevi/sawyer_ws/src/sawyer_simulator/sawyer_sim_controllers/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT sawyer_sim_controllers_NUM_DUMMY_TARGETS)
      set(sawyer_sim_controllers_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::sawyer_sim_controllers::wrapped-linker-option${sawyer_sim_controllers_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR sawyer_sim_controllers_NUM_DUMMY_TARGETS "${sawyer_sim_controllers_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::sawyer_sim_controllers::wrapped-linker-option${sawyer_sim_controllers_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND sawyer_sim_controllers_LIBRARIES "${interface_target_name}")
