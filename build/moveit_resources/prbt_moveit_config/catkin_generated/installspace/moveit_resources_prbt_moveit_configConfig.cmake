...
if("FALSE" STREQUAL "TRUE")
  set(moveit_resources_prbt_moveit_config_SOURCE_PREFIX /home/sridevi/sawyer_ws/src/moveit_resources/prbt_moveit_config)
  set(moveit_resources_prbt_moveit_config_DEVEL_PREFIX /home/sridevi/sawyer_ws/devel)
  ...
  set(moveit_resources_prbt_moveit_config_INSTALL_PREFIX /home/sridevi/sawyer_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_resources_prbt_moveit_config' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
